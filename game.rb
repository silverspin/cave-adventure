...
make_pie do
  ...
  create_places do
    cave description:"you are in a cave, with two paths in front of you. the right hes a warm draft, the left has a cold chill"
    ...
    lake description:"you come to an underwater lake. as you draw neer, some... thing... comes out of the water and lets you breathe underwater. it tells you to go for a swim." 
    ...
    atlantis description:"as you submerge into the water, you se a hidden underwater city. they invite you to live there. you accept and happily grow old there, becoming a very good swimmer with very prune-y fingers."
    ...
    victory description:"You by Pie. CONGRATULATIONS! YOU WIN! NOT ONLY IS PIE INFINATE, BUT THIS GAME WAS MADE USING PIE! PLUS, SOMWHERE ALONG THE WAY,PIE HAS THE NUMBER 42 IN IT! YOU NOW KNOW THE SECRET TO THE UNIVERSE."
    indiana_jones_ending description:"Indiana jones rus in, fires some shots behind him, and pushes a rock in front of the entrance. he sees you with the skull and invites you to join his adventures. after a short gunfight, you ride off into the sunset with him."
    restart description:"you go towards the light. you see the grm reaper. he says 'if you want, i could revive you at the begining of this whole adventure, but you'll owe me one. deal?'"
  end
